...
このリポジトリは、push のたびに 1188 項目の検査を通します。 依存パッケージはありません。

```
node verification/check_text.js      # 誤変換とバッジ記法
node verification/check_contrast.js  # 配色の読みやすさ 413 項目
node verification/check_site.js      # サイトの構造 685 項目
