...
| [trinity-infinity](https://github.com/cpsbvbng26-dotcom/trinity-infinity) | Trinity-Infinity の三篇と、その検証 150 項目（定理 15・印字された数値 32・正誤表の監査 78・経路 25）。何が確立され何が撤回されたかの記録と正誤 | CC BY 4.0 | — |
