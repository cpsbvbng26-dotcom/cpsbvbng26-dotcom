...
| 自由が丘産能短期大学 能率科 経営管理コース | 二年間在籍後、自主退学 | スクーリングで 2 単位 |
| オンライン大学 情報社会系の学部 | 在籍（秋入学一期生） | 数学史（選択必修科目） |

<details>
<summary>修得した科目（一覧は <a href="https://cpsbvbng26-dotcom.github.io/cpsbvbng26-dotcom/cv.html">CV</a> にもある）</summary>

**自由が丘産能短期大学 能率科 経営管理コース**

| 科目 | 区分 | 単位 |
| --- | --- | --- |
| 仕事の上手な教え方（インストラクショナルデザイン） | スクーリング | 2 |

**1 科目 2 単位。**

**オンライン大学 情報社会系の学部** —— これから増える。
