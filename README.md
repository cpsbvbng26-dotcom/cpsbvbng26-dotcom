...
**城外の陣屋は六つある**。特性ごとに一つずつで、運営母体まで調べて
[`docs/canonical-sources.md`](docs/canonical-sources.md) に並べてある。
陣屋は正本ではない。人を探しに来た者が着いて、そこで止まる場所である。

**当てはめて出た弱点は二つである。**

一つ。**縄張りの上から四つが、墨付も凍結も持たない**。天守閣・本丸・石垣・出丸である。
引用できる識別子も、固定された版も無い。

二つ。**陣屋の三つは、同じ手が計測も持っている**。SSRN と PlumX は Elsevier、
...
| 本丸 | `trinity-infinity` | **墨付なし・凍結なし**。免状 CC BY 4.0。三篇の DOI はあるが、リポジトリ自身には無い。核である。定理・正誤表・経路。ここが落ちれば全部落ちる |
| 石垣 | `self-correction` | **墨付なし・凍結なし**。免状 MIT。外からは見えない。全部これに載っている。git が全版から id を集めるので崩せない |
| 出丸 | `trinity-operator` | **墨付なし・凍結なし**。免状 MIT。本丸の外に突き出た曲輪である。実際に撃ち合う場所。作用素ノルムとスペクトル半径の反例はここにある |
...
| | 数 | どれ |
| --- | --- | --- |
| 墨付（自分の DOI）を持たない | **六つ** | 天守閣・本丸・石垣・出丸・二の丸・三の丸の片方 |
| 凍結された版（タグ）を持たない | **五つ** | 天守閣・本丸・石垣・出丸・三の丸の片方 |
| **両方を欠く** | **五つ** | 上の五つがそのまま重なる |

**天守閣・本丸・石垣・出丸が、四つとも両方を欠いている**。引用できる識別子も、
固定された版も無い。**縄張りの上から四つが、いちばん引きにくい。**
