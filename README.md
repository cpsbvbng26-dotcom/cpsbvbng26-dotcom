...
<sub>この写真を二つの場に掛けました（2026-09-22）。顔面偏差値は IKACHI が 57.2、LUFT が 65 でした。IKACHI が添える上位 23.58% は順位ではなく、平均 50・標準偏差 10 の正規分布から出した数です。二件なので中央値は出しません。どちらも診断の仕組みは確かめていません。</sub>
