...
const CASES = [
  ...
  ['Figshare の所属を締め出しの理由と結ぶと落ちる', 'docs/canonical-sources.md',
   swap('**それが締め出しの理由だとは書きません**。', '**それが締め出しの理由である**。'),
