...
`zenodo.org` にも `doi.org` にも DataCite にも届かない。

**番号の存在は疑っていない。**登録したのは著者本人であり、番号は Zenodo が発行した
ものを著者が読み取って渡している。**確かめられないのは、書き写しが合っているかと、
どのレコードを指すかである。**決まらないものは「未確認」と書く。番号を当てにいかない。
...
**`22649054` と `22649899` を `22685687` に置換しない。**写して使っている側は、
...
| A Naval Gazette Entry for Lieutenant Otani Tsune | `10.5281/zenodo.22055709` | SSRN `10.2139/ssrn.7449338` |
