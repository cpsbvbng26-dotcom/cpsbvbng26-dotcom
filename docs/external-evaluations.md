...
**器の格は本物である。**だから陣屋に見えるのは当然で、**だから食い違いの代償が大きい。**
...
**2026年9月17日、[canonical-sources.md](canonical-sources.md) の「陣屋は三つある」で
陣屋と正本を分けた。**
...
**この二つを分けたので、「写しが陣屋に見える」はもう矛盾ではない。**
**陣屋は写しであってよい。**正本に勝てないことが書いてあれば足りる。

**Zenodo は陣屋から外れた。**プロフィールの頁を持たないためである。
...
**SSRN・Google Scholar・Kudos を陣屋に加えたのは、プロフィールの頁を持つからである**
（いずれも利用者の指摘）。**加えた結果、陣屋の三つが営利企業の手に入った。**

**そしてその三つは、同じ手が計測も持っている。**Elsevier は SSRN と PlumX、
Google は Google Scholar と被引用数、Kudos は面と共有の経路の数である。
**陣屋と計測が同じ手にある例が三つになった。**置いた先が数えているとき、
