...
| [Trinity-Infinity Framework, Series III](https://doi.org/10.5281/zenodo.22058964) | Shows the convergence result never required three elements — it holds for every n ≥ 2 — and gives a retrospective on what the series established and what it withdrew | Aug 2026 | [10.5281/zenodo.22058964](https://doi.org/10.5281/zenodo.22058964)<br>HAL [hal-05759296](https://hal.science/hal-05759296) |
...
**Every push runs 1197 checks.** There are no dependencies to install.
...
node verification/check_site.js      # site structure, 694 checks
