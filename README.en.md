...
| [trinity-infinity](https://github.com/cpsbvbng26-dotcom/trinity-infinity) | The three Trinity-Infinity papers with 150 verification checks (15 on the theorems, 32 on the printed numerics, 78 on the errata, 25 on the route), an errata record, and an account of what the series established and what it withdrew | CC BY 4.0 | — |
